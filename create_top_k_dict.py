...
# change path accordingly to the dataset you want to use
...
def search_with_id(song_id: str, k: int = 100, measure='cosine', features='basic'):
    """
...
for song_id in tqdm(id_information['id']):  # .head(1000)['id']):
    top_k = search_with_id(song_id, measure=measure, features=features)
